...
export function Services() {
  return (
    <section
      id="servicios"
      className="relative bg-[#030712] py-20 sm:py-28 lg:py-32"
    >
      {/* Background glow */}
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-6 text-base leading-relaxed text-[#9CA3AF] sm:mt-8 sm:text-lg">
          ...
          <p className="mt-4 text-base leading-relaxed text-[#F9FAFB]/80 sm:text-lg">
        ...
        >
          ...
          <h2 className="mt-3 text-[28px] leading-tight font-bold text-[#F9FAFB] sm:text-[36px] md:text-[42px]">
        ...
        <motion.div
          ...
          className="mt-12 grid gap-5 sm:mt-16 sm:gap-8 md:grid-cols-2"
        >
          {services.map((service, index) => (
            ...
            >
              <div className="group relative h-full rounded-xl border border-[#1F2937] bg-[#111827]/50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#3B82F6]/30 hover:bg-[#111827] hover:shadow-xl hover:shadow-[#3B82F6]/10 sm:rounded-2xl sm:p-8">
                {/* Icon */}
                <div className="relative">
                  ...
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-lg bg-[#1F2937] transition-colors duration-300 group-hover:bg-[#3B82F6]/20 sm:h-14 sm:w-14 sm:rounded-xl">
                    <service.icon
                      size={24}
